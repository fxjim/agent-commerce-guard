...
- Base Account checkout: the official `/pay` page leads with a user-confirmed 1 USDC payment, links to proof, the Base MCP recipe, and support before payment, and verifies the returned transaction server-side before unlock.
